...
use Songbird\Document\Repository\Repository;
...
class Query
{
    ...
    {
        $page = Request::createFromGlobals()->query->get('page', 1);
        $offset = $count * ($page < 1 ? 1 : $page) - $count;
    ...
    public function execute()
    {
        ...
        return new Result($documents, $totalCount, $count);
    }
